...
<ol class="numbered-list reveal">
  ...
  <li>
    <div>
      <h3>Request the deployment package</h3>
      <p>Email the project team using the details on the <a href="/projects/contact/">Contact</a> page. Include your school code and grade levels (7th&ndash;12th).</p>
    </div>
  </li>
  <li>
    <div>
