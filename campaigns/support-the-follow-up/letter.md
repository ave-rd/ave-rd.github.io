...
alt_url: /es/avale/carta/
signature_key: follow_up_pledge
letter_place: "Open letter — international research community"
letter_date: "9 May 2026"
letter_recipient: |
  <p><strong>To: foundations, bilateral and multilateral funders, and the long-run-RCT research community</strong></p>
letter_salutation: "Colleagues,"
letter_closer: "Sincerely,"
letter_signed_by: "The undersigned researchers and partners"
sitemap: false
---
...
<p>
  <strong>The original AVE-RD evaluation, completed in
  <span class="font-osf">2017</span>, established that a brief,
  video-based information intervention can shift schooling
  decisions in a low- to middle-income setting.</strong> Dropout
  fell by <span class="font-osf">2.5&ndash;3</span>&nbsp;percentage
  points; standardized test scores rose by
  <span class="font-osf">0.05&ndash;0.13</span> standard deviations;
  beliefs about the wage returns to schooling moved measurably.
  These are short-term effects; they answer the schooling
  question. They do not answer the earnings question.
</p>
...
<p>
  ...
  &mdash; protocols, instruments, code &mdash; as a reusable
  benchmark for similar interventions in other countries.
</p>
