...
alt_url: /campaigns/support-the-follow-up/letter/
signature_key: follow_up_pledge
letter_place: "Carta abierta — comunidad internacional de investigación"
letter_date: "9 de mayo de 2026"
letter_recipient: |
  <p><strong>A: fundaciones, donantes bilaterales y multilaterales, y la comunidad de investigación en RCT de largo plazo</strong></p>
letter_salutation: "Estimadas y estimados colegas:"
letter_closer: "Atentamente,"
letter_signed_by: "Los investigadores y socios firmantes"
sitemap: false
---
...
<p>
  <strong>La evaluación original AVE-RD, finalizada en
  <span class="font-osf">2017</span>, estableció que una
  intervención breve basada en video puede modificar las decisiones
  de escolarización en un contexto de ingresos bajos y
  medios.</strong> La deserción se redujo en
  <span class="font-osf">2.5&ndash;3</span>&nbsp;puntos
  porcentuales; los resultados estandarizados aumentaron
  <span class="font-osf">0.05&ndash;0.13</span> desviaciones
  estándar; las creencias sobre los retornos salariales de la
  educación se desplazaron de forma medible. Estos son efectos de
  corto plazo: responden a la pregunta de escolaridad, pero no a
...
<p>
  ...
  &mdash; como referente reutilizable para intervenciones similares
  en otros países.
</p>
